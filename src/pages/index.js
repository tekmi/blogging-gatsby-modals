...
const IndexPage = () => {
  ...
  return (
    <>
      <SEO title="Home"/>
      <ButtonGroup>
        <Button color="info" onClick={() => toggleModalWithContent(() => "adam")}>Open Modal</Button>
        <Button color="warning" onClick={() => toggleModalWithContent(() => 11)}>Open Number Modal</Button>
        <Button color="success" onClick={() => toggleModalWithContent(() => [11, 22, 33])}>Open Array Modal</Button>
